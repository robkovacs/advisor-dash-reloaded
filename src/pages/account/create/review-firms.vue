...
<template>
  <Stack gap="8">
    <Stack gap="4">
      <Button variant="link" size="small" @click="back()"><IconArrowLeft />Back</Button>
    ...
    <Stack gap="4">
      <Button variant="primary" @click="next()">Create a new firm</Button>
      <Row justify="center">
        <Button variant="link" size="small">Ask a colleague to setup your firm instead</Button>
      </Row>
    </Stack>
  </Stack>
</template>
